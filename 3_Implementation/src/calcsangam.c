...
int main()
{
    float san1,san2,res,mults,divs,subs,adds,sine,cosi,tani,coseci,seci,coti,arcsini,arccosi,arctani,arccoseci,arcseci,arccoti,ang;
    int symbols;
   ...
   switch(symbols)
    {
       ...
       scanf("%f",&san1);
         ...
         case 5: //sine value in radian
          ...
          printf("sin=%f\n",sine);
        break;
         case 6: //cosine value in radian
            printf("Enter The Value Of angle\n");
           scanf("%f",&ang);
           cosi=cos(ang);
           printf("cos=%f\n",cosi);
          break;
               case 7: //tan value in radian
          printf("Enter The Value Of Angle\n");
          scanf("%f",&ang);
          tani=tan(ang);
          printf("tan=%f\n",tani);
          break;
       case 8: //cosec value in radian
          printf("Enter The Value Of Angle\n");
            scanf("%f",&ang);
           coseci=1/sin(ang);
            printf("cosec=%f\n",coseci);
            break;
        case 9: //sec value in radian
        printf("Enter The Value Of Angle\n");
         scanf("%f",&ang);
         seci=1/cos(ang);
       printf("sec=%f\n",seci);
     ...
     break;
    case 14: //cosec inverse in radian
     printf("Enter The Value\n");
     scanf("%f",&ang);
    arccoseci=1/asin(ang);
   printf("cosec inverse=%f\n",arccoseci);
   break;
   case 15: //sec inverse in radian
   printf("Enter The Value\n");
   scanf("%f",&ang);
   arcseci=1/acos(ang);
